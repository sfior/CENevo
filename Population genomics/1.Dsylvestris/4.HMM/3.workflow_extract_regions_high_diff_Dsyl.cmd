...
do
cd 'hmm.chr'${i}
Rscript  ../4_overlap_high_differentiation_states.R combined_hmm_all_pairs_reduced.txt "pop1.pop3","pop2.pop6","pop4.pop5","pop1.pop4","pop1.pop6","pop2.pop3","pop2.pop4","pop3.pop5","pop5.pop6" Overlapping_Outliers_ite_500
cd $cwd
done
...
do
cd 'hmm.chr'${i}
cat Overlapping_Outliers_ite_500_pop1.pop3_pop2.pop6_pop4.pop5_pop1.pop4_pop1.pop6_pop2.pop3_pop2.pop4_pop3.pop5_pop5.pop6.txt | cut -f1 | sort | uniq | grep scaff > list_scaffolds_with_hmm_outliers.txt
cd $cwd
done

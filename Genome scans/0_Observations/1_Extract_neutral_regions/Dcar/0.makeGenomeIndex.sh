...
ref_directory="/cluster/project/gdc/shared/p219/1_Assemblies/Dcarthusian"
...
awk -v OFS='\t' {'print $1,$2'} ${ref_directory}/assembly_homozygous.fa.fai > ./Dcarth_assembly_homozygous.genome
...
#awk {'print $1,"",$2'} ${ref_directory}/assembly_homozygous.fa.fai > ./Dcarth_assembly_homozygous.genome
# if 'chr' needs to be added infront of the chromosome/scaffold names do this
#awk {'print "chr"$1,"",$2'} ${ref_directory}/assembly_homozygous.fa.fai > ./Dcarth_assembly_homozygous.genome

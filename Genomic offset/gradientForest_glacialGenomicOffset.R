##### This script performs gradient forest modelling to investigate composition of whole-genome adaptive genetic variation across space and time (current, future and LGM) #####

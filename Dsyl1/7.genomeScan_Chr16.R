...
#prefix_dir <- "Estimation_results_simpleModel_11params_RECON2_newSSminDP10maxDP200_Dsyl_3RunsCombined_PLS20_Joint_retSims10000_gridPoints33_FINAL"
prefix_dir <- "Estimation_results_simpleModel_11params_RECON2_newSS_minDP10maxDP200_Dsyl_3RunsCombined_PLS20_Joint_retSims10000_gridPoints33_FINAL"
...
# Add linkage group position and chromosome number (not applicable for Chr 16, as this comprises not a real chromosome but rather all unanchored scaffolds)
genomeScan_table[,13]<- NA
genomeScan_table[,14]<- NA
genomeScan_table[,15]<- NA
...
# Sort by chromosome position (first) and windows (second) (not applicable (i.e. hash out) for Chr 16, as this comprises not a real chromosome but rather all unanchored scaffolds)

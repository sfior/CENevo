...
# Not necessary for genome-wide neutral observations here because there are no zero segsite windows.

for i in Dcar/5kbFlankMaker_0kbFlankOthers Dsyl/5kbFlankMaker_1kbFlankOthers; do 

	# Change into Chr directory
	cd ${i}

	# Define input variables
	obs_file=$(ls *windowsize5000_M2_Q0.obs)
	scaflist_file=$(ls *windowsize5000_M2_Q0.scaffoldlist)
